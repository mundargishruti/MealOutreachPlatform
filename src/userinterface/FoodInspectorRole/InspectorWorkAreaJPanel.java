...
public class InspectorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private OrgFoodInspector hlthCrOfcrJPanel;
    private Enterprise entrpz;

    /**
     * Creates new form OfficerWorkAreaJPanel1
     */
    public InspectorWorkAreaJPanel(JPanel jpanel, SystemUsers userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
        this.entrpz = enterprise;

        this.jPanel = jpanel;

        this.hlthCrOfcrJPanel = (OrgFoodInspector) organization;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/istockphoto-1184468483-1024x1024.jpg"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnVrcfnOnMap, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnProcessReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessReqActionPerformed
        ...
        if (slRow < 0) {
            ...
            if (!usrAcnt.getEmploye().equals(request.getRcvr().getEmploye())) {
                ...
                InspectorWorkRequestJPanel panel = new InspectorWorkRequestJPanel(jPanel, usrAcnt, request, entrpz);
